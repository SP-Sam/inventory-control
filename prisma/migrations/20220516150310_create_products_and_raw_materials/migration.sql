...
-- AddForeignKey
ALTER TABLE `RawMaterialsOnProducts` ADD CONSTRAINT `RawMaterialsOnProducts_product_code_fkey` FOREIGN KEY (`product_code`) REFERENCES `products`(`code`) ON DELETE RESTRICT ON UPDATE CASCADE;
